...
public final class Constants {
	...
	public static final double KIDS_STORY_TIME_DURATION = 1.0;
	...
	public static final double KIDS_STORY_TIME_RATE = 3.0;
	public static final double MOVIE_NIGHT_RATE = 3.0;
	public static final double BOOK_LAUNCH_RATE = 2.0;
