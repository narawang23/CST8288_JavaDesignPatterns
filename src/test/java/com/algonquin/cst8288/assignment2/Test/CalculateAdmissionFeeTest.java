...
class EventTests {
    ...
    void testKidsStoryTimeAdmissionFee() {
        ...
        assertEquals(expectedFee, event.getAdmissionFees(), "Admission fee for Kids Story Time should be calculated correctly");
    }
    ...
    void testBookLaunchAdmissionFee() {
        ...
        assertEquals(expectedFee, event.getAdmissionFees(), "Admission fee for Book Launch should be calculated correctly");
    }
    ...
    void testMovieNightAdmissionFee() {
        ...
        assertEquals(expectedFee, event.getAdmissionFees(), "Admission fee for Movie Night should be calculated correctly");
    }
  ...
  //for Workshop
    ...
    void testWorkshopAdmissionFee() {
        ...
        assertEquals(expectedFee, event.getAdmissionFees(), "Admission fee for Workshop should be calculated correctly");
    }
}
